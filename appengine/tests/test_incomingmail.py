...
from codereview import models, views, view_mail
...
class TestIncomingMail(TestCase):
  ...
  def test_unknown_issue(self):
    ...
    self.assertRaises(views.InvalidIncomingEmailError,
                      view_mail._process_incoming_mail, msg.as_string(),
  ...
  def test_senders_becomes_reviewer(self):
    ...
    msg.set_payload('body')
    view_mail._process_incoming_mail(msg.as_string(), 'reply@example.com', self.semester)
